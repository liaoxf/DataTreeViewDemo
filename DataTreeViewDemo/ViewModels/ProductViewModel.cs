...
namespace DataTreeViewDemo.ViewModels {
    public class ProductViewModel {
        ...
        private IEnumerable<Product> GeneratePivotData() {
            var pivotData = new ObservableCollection<Product>()
                                           {
                                               new Product()
                                                   {
                                                       Name = "Pen",
        ...
        public ProductViewModel() {
            this.Products = new ObservableCollection<Product>(this.GeneratePivotData());
        }
    }
}
